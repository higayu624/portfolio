...
type User struct {
	...
	// ロール
	UserRole null.Int `boil:"user_role" json:"user_role,omitempty" toml:"user_role" yaml:"user_role,omitempty"`
	// ステータス
	UserStatus null.Int  `boil:"user_status" json:"user_status,omitempty" toml:"user_status" yaml:"user_status,omitempty"`
...
var UserWhere = struct {
	...
	UserRole    whereHelpernull_Int
	UserStatus  whereHelpernull_Int
	UpdatedAt   whereHelpertime_Time
	CreatedAt   whereHelpertime_Time
	DeletedAt   whereHelpernull_Time
}{
	ID:          whereHelperint{field: "\"users\".\"id\""},
	GivenName:   whereHelpernull_String{field: "\"users\".\"given_name\""},
	FamilyName:  whereHelpernull_String{field: "\"users\".\"family_name\""},
	DisplayName: whereHelpernull_String{field: "\"users\".\"display_name\""},
	MailAddress: whereHelpernull_String{field: "\"users\".\"mail_address\""},
	UserRole:    whereHelpernull_Int{field: "\"users\".\"user_role\""},
	UserStatus:  whereHelpernull_Int{field: "\"users\".\"user_status\""},
...
func (r *userR) GetProducts() ProductSlice {
	if r == nil {
		return nil
	}
	return r.Products
...
var (
	userAllColumns            = []string{"id", "given_name", "family_name", "display_name", "mail_address", "user_role", "user_status", "updated_at", "created_at", "deleted_at"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "given_name", "family_name", "display_name", "mail_address", "user_role", "user_status", "updated_at", "created_at", "deleted_at"}
...
func (o *User) Products(mods ...qm.QueryMod) productQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"products\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadProducts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`products`),
		qm.WhereIn(`products.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Product) error {
	var err error
