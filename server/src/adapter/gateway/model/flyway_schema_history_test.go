...
var (
	flywaySchemaHistoryDBTypes = map[string]string{`InstalledRank`: `integer`, `Version`: `character varying`, `Description`: `character varying`, `Type`: `character varying`, `Script`: `character varying`, `Checksum`: `integer`, `InstalledBy`: `character varying`, `InstalledOn`: `timestamp without time zone`, `ExecutionTime`: `integer`, `Success`: `boolean`}
	_                          = bytes.MinRead
)
