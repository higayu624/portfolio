...
func FindFlywaySchemaHistory(ctx context.Context, exec boil.ContextExecutor, installedRank int, selectCols ...string) (*FlywaySchemaHistory, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"flyway_schema_history\" where \"installed_rank\"=$1", sel,
	)
...
func (o *FlywaySchemaHistory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"flyway_schema_history\" %sDEFAULT VALUES%s"
		}
...
func (o *FlywaySchemaHistory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"flyway_schema_history\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *FlywaySchemaHistory) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"flyway_schema_history\" WHERE \"installed_rank\"=$1"
...
func FlywaySchemaHistoryExists(ctx context.Context, exec boil.ContextExecutor, installedRank int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"flyway_schema_history\" where \"installed_rank\"=$1 limit 1)"
