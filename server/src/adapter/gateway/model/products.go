...
type Product struct {
	...
	ProductLink null.String `boil:"product_link" json:"product_link,omitempty" toml:"product_link" yaml:"product_link,omitempty"`
	Title       null.String `boil:"title" json:"title,omitempty" toml:"title" yaml:"title,omitempty"`
	SubTitle    null.String `boil:"sub_title" json:"sub_title,omitempty" toml:"sub_title" yaml:"sub_title,omitempty"`
	Exposition  null.String `boil:"exposition" json:"exposition,omitempty" toml:"exposition" yaml:"exposition,omitempty"`
	AppealPoint null.String `boil:"appeal_point" json:"appeal_point,omitempty" toml:"appeal_point" yaml:"appeal_point,omitempty"`
...
var ProductTableColumns = struct {
	...
	Exposition:  "products.exposition",
	AppealPoint: "products.appeal_point",
...
var ProductWhere = struct {
	...
	ProductLink whereHelpernull_String
	Title       whereHelpernull_String
	SubTitle    whereHelpernull_String
	Exposition  whereHelpernull_String
	AppealPoint whereHelpernull_String
	UpdatedAt   whereHelpertime_Time
	CreatedAt   whereHelpertime_Time
	DeletedAt   whereHelpernull_Time
}{
	ID:          whereHelperint{field: "\"products\".\"id\""},
	UserID:      whereHelperint{field: "\"products\".\"user_id\""},
	ProductLink: whereHelpernull_String{field: "\"products\".\"product_link\""},
	Title:       whereHelpernull_String{field: "\"products\".\"title\""},
	SubTitle:    whereHelpernull_String{field: "\"products\".\"sub_title\""},
	Exposition:  whereHelpernull_String{field: "\"products\".\"exposition\""},
	AppealPoint: whereHelpernull_String{field: "\"products\".\"appeal_point\""},
...
type productR struct {
	...
	TechnicalStacks TechnicalStackSlice `boil:"TechnicalStacks" json:"TechnicalStacks" toml:"TechnicalStacks" yaml:"TechnicalStacks"`
}
...
func (r *productR) GetTechnicalStacks() TechnicalStackSlice {
	if r == nil {
		return nil
	}
	return r.TechnicalStacks
}
...
var (
	productAllColumns            = []string{"id", "user_id", "product_link", "title", "sub_title", "exposition", "appeal_point", "updated_at", "created_at", "deleted_at"}
	productColumnsWithoutDefault = []string{"user_id"}
	productColumnsWithDefault    = []string{"id", "product_link", "title", "sub_title", "exposition", "appeal_point", "updated_at", "created_at", "deleted_at"}
...
func (o *Product) User(mods ...qm.QueryMod) userQuery {
...
// TechnicalStacks retrieves all the technical_stack's TechnicalStacks with an executor.
func (o *Product) TechnicalStacks(mods ...qm.QueryMod) technicalStackQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"technical_stacks\".\"product_id\"=?", o.ID),
	)

	return TechnicalStacks(queryMods...)
}

// LoadUser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (productL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
...
// LoadTechnicalStacks allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (productL) LoadTechnicalStacks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
	...
	query := NewQuery(
		qm.From(`technical_stacks`),
		qm.WhereIn(`technical_stacks.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load technical_stacks")
	}

	var resultSlice []*TechnicalStack
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice technical_stacks")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on technical_stacks")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for technical_stacks")
	}
	...
	if singular {
		object.R.TechnicalStacks = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &technicalStackR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ProductID {
				local.R.TechnicalStacks = append(local.R.TechnicalStacks, foreign)
				if foreign.R == nil {
					foreign.R = &technicalStackR{}
				}
...
// SetUser of the product to the related item.
// Sets o.R.User to related.
// Adds o to related.R.Products.
func (o *Product) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
...
// AddTechnicalStacks adds the given related objects to the existing relationships
// of the product, optionally inserting them as new records.
// Appends related to o.R.TechnicalStacks.
// Sets related.R.Product appropriately.
func (o *Product) AddTechnicalStacks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TechnicalStack) error {
	var err error
	...
	if o.R == nil {
		o.R = &productR{
			TechnicalStacks: related,
		}
	} else {
		o.R.TechnicalStacks = append(o.R.TechnicalStacks, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &technicalStackR{
				Product: o,
			}
		} else {
			rel.R.Product = o
